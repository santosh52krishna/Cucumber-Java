@YPO
Feature: YPO CheckoutCheckWire Page UI Test
  This is the description for CheckoutCheckWire Page

  Scenario: LayOutTest For YPO CheckoutCheckWire Page Content
